...
const Sidebar = () => {
  const { whoMe, logOut ,user} = useAuth();
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v3" />
    ...
    { name: "View Request", path: "/user-request", icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side">
        ...
        <div className="menu bg-[#2C3E50] text-white min-h-screen w-64 p-4">
...
{user &&     (     <button
            onClick={OnLogout}
            className="flex items-center gap-2 p-2 rounded mt-4 bg-red-400 text-black"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
